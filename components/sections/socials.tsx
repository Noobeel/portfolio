...
export default function Socials() {
    ...
    return (
        <>
            ...
            >
                <div className="flex flex-col justify-center items-center w-max h-max backdrop-blur-md rounded-l-lg bg-gradient-to-r from-gray-300 to-[#b0b0b0] dark:from-gray-900 dark:to-slate-800">
